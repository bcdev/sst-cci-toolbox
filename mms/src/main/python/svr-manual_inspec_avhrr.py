...
files=['19950119004700-ESACCI-L2P_GHRSST-SSTskin-AVHRR14_G-LT-v02.0-fv01.0.nc',\
           '19981031074500-ESACCI-L2P_GHRSST-SSTskin-AVHRR15_G-LT-v02.0-fv01.0.nc',\
           '19981130004100-ESACCI-L2P_GHRSST-SSTskin-AVHRR12_G-LT-v02.0-fv01.0.nc',\
           '20001223080000-ESACCI-L2P_GHRSST-SSTskin-AVHRR14_G-LT-v02.0-fv01.0.nc',\
           '20010401171200-ESACCI-L2P_GHRSST-SSTskin-AVHRR16_G-LT-v02.0-fv01.0.nc',\
           '20020228173400-ESACCI-L2P_GHRSST-SSTskin-AVHRR15_G-LT-v02.0-fv01.0.nc',\
           '20020713020900-ESACCI-L2P_GHRSST-SSTskin-AVHRR17_G-LT-v02.0-fv01.0.nc',\
           '20050702161200-ESACCI-L2P_GHRSST-SSTskin-AVHRR18_G-LT-v02.0-fv01.0.nc',\
           '20050908114300-ESACCI-L2P_GHRSST-SSTskin-AVHRR16_G-LT-v02.0-fv01.0.nc',\
           '20061121120000-ESACCI-L2P_GHRSST-SSTskin-AVHRRMTA_G-LT-v02.0-fv01.0.nc',\
           '20100927170800-ESACCI-L2P_GHRSST-SSTskin-AVHRRMTA_G-LT-v02.0-fv01.0.nc',\
           '20101001015000-ESACCI-L2P_GHRSST-SSTskin-AVHRR18_G-LT-v02.0-fv01.0.nc',\
           '20101230222300-ESACCI-L2P_GHRSST-SSTskin-AVHRR17_G-LT-v02.0-fv01.0.nc',\
           '19911012215100-ESACCI-L2P_GHRSST-SSTskin-AVHRR12_G-LT-v02.0-fv01.0.nc']

#files=['19911012215100-ESACCI-L2P_GHRSST-SSTskin-AVHRR12_G-LT-v02.0-fv01.0.nc']
...
#    print num1,num2,np.min(diff1),np.max(diff1),np.min(diff2),np.max(diff2),len(diff1)
    ...
    if (var.shape[0] > 12000):
        ...
        cbar = plt.colorbar(cs)
        plt.subplot(177)
        cs = plt.imshow(ssess_bias[12000:,:])
        cbar = plt.colorbar(cs)
    else:
