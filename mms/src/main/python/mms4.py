...
w.run(mmdtype, calls=[('sampling-start.sh', 1), ('clearsky-start.sh', 4),('sub-start.sh', 4), ('coincidence-start.sh', 4), ('reingestion-start.sh', 2), ('matchup-reingestion-start.sh', 2), ('mmd-start.sh', 4)], with_history=True)
