...
w.run(mmdtype, calls=[('sampling-start.sh', 1), ('sub-start.sh', 60), ('coincidence-start.sh', 6), ('reingestion-start.sh', 4), ('matchup-reingestion-start.sh', 2), ('mmd-start.sh', 60)], with_history=True)
