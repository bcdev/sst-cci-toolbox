...
# mms/archive/mms2/matchup/atsr.3/2003/atsr.3-matchup-2003-01.nc
# mms/archive/mms2/arc/atsr.3/2003/atsr.3-arc-2003-01.nc
# mms/archive/mms2/mmd/atsr.3/2003/atsr.3-mmd-2003-01-all.nc
# mms/archive/mms2/mmd/atsr.3/2003/atsr.3-mmd-2003-01-sel.nc
...
class Workflow:
    ...
    def run(self, mmdtype, hosts=list([('localhost', 18)]), calls=list(), log_dir='trace',
            with_history=False,
