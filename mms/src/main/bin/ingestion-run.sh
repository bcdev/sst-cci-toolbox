...
-Dmms.source.22.inputDirectory=avhrr.n10/${year}/${month} \
-Dmms.source.23.inputDirectory=avhrr.n11/${year}/${month} \
-Dmms.source.24.inputDirectory=avhrr.n12/${year}/${month} \
