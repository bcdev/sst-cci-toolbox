...
echo "./MMD_SCREEN_Linux $inp $sensor-nwp-$startTimeCompact-$stopTimeCompact.nc $sensor-nwp-$startTimeCompact-$stopTimeCompact.nc $sensor-arc3-$startTimeCompact-$stopTimeCompact.nc"
