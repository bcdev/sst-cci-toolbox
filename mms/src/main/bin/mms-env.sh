...
submit_job() {
    jobname=$1
    command=$2
    hosts="host017 host018 host019 host021 host022 host023 host024 host025 host026 host027 host028 host040 host041 host042 host043 host044 host045"
    bsubmit="bsub -R rusage[mem=8192] -q lotus -m ${hosts} -n 1 -W 8:00 -P esacci_sst -cwd ${MMS_INST} -oo ${MMS_LOG}/${jobname}.out -eo ${MMS_LOG}/${jobname}.err -J ${jobname} ${MMS_HOME}/bin/${command} ${@:3}"
