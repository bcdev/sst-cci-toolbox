...
public class ObservationFinderTest {
    ...
    public void testFindDualSensorMatchups() throws ParseException {
        ...
        final PolarOrbitingPolygon orbitPolygonAatsr = createPolarOrbitingPolygon(
        ...
        final PolarOrbitingPolygon orbitPolygonAtsr2 = createPolarOrbitingPolygon(
    ...
    private static PolarOrbitingPolygon createPolarOrbitingPolygon(String time, Point[] points) throws ParseException {
        ...
        return new PolarOrbitingPolygon(1, orbitTimeAatsr, orbitGeometryAatsr);
    }
