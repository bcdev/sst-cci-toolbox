...
public class NcAvhrrGacProductReaderPlugInTest {
    ...
    public void testGetDecodeQualification() throws Exception {
        ...
        final File file = getResourceAsFile("20100101000000-AVHRR-L1b-AVHRR18_G-v02.0-fv01.0.nc");

        assertEquals(DecodeQualification.INTENDED,
                     plugIn.getDecodeQualification(file));
        assertEquals(DecodeQualification.INTENDED,
                     plugIn.getDecodeQualification(file.getPath()));

        assertEquals(DecodeQualification.UNABLE,
                     plugIn.getDecodeQualification("20100601.egr"));
        assertEquals(DecodeQualification.UNABLE,
                     plugIn.getDecodeQualification("aai_20101224.nc"));
        assertEquals(DecodeQualification.UNABLE,
                     plugIn.getDecodeQualification("ice_conc_nh_201006301200.hdf"));
        assertEquals(DecodeQualification.UNABLE,
                     plugIn.getDecodeQualification("ice_conc_sh_qual_201006301200.hdf"));
    }

    @Test
    public void testMatches() throws Exception {
        assertTrue(NcAvhrrGacProductReaderPlugIn.matches("20100101000000-AVHRR-L1b-AVHRR18_G-v02.0-fv01.0.nc"));
    }
