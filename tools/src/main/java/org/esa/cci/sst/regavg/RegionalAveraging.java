    ...
    private static List<Cell> computeOutputTimeStep(FileStore fileStore,
        ...
        for (RegionMask regionMask : regionMaskList) {
            ...
            if (regionMask.getCoverage() == RegionMask.Coverage.Globe
                ...
                CellGrid regional90DegGrid = aggregate5DegTo90DegGrid(regional5DegGrid, combinedRegionMask);
                regionalCells.add(regional90DegGrid.aggregate(climatology.getSeaCoverage90DegGrid()));
            } else {
                regionalCells.add(regional5DegGrid.aggregate(climatology.getSeaCoverage5DegGrid()));
            }
        }
