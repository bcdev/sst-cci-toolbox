...
public final class SynopticCell5 extends AbstractAggregationCell implements SpatialAggregationCell {
    ...
    public SynopticCell5(AggregationContext aggregationContext, int x, int y) {
