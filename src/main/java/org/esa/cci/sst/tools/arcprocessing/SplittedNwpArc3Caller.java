...
/**
 * Creates an ARC3 call, splitted in submit and reingestion call.
 *
 * @author Thomas Storm
 */
class SplittedNwpArc3Caller implements NwpArc3Caller {

    private final Properties configuration;

    SplittedNwpArc3Caller(Properties configuration) {
