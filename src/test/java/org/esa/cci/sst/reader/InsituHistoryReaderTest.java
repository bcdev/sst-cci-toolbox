...
public class InsituHistoryReaderTest {
    ...
    private InsituHistoryIOHandler ioHandler;
    ...
    public void testGetTime() throws Exception {
        InsituHistoryIOHandler.TimeInterval time = ioHandler.getTime("insitu_WMOID_11851_20100101_20100101.nc");
        ...
        time = ioHandler.getTime("insitu_WMOID_11851_20100101_20100103.nc");
        test = new GregorianCalendar(2010, 0, 2).getTime();
        assertEquals(test.getTime(), time.centralTime.getTime());
        long oneDay = 1000 * 60 * 60 * 24;
        assertEquals(oneDay, time.timeRadius);

        time = ioHandler.getTime("insitu_WMOID_11851_20110101_20130101.nc");
        test = new GregorianCalendar(2012, 0, 1, 12, 0).getTime();
        assertEquals(test.getTime(), time.centralTime.getTime());

        time = ioHandler.getTime("insitu_WMOID_11851_20110101_20110111.nc");
